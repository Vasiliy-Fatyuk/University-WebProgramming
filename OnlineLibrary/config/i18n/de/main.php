...
return array(
    ...
    "kod_name_desc"                  => "Mango Wolke • OnlineLibrary",
    "kod_power_by"                   => " - Powered by KodExplorer",
    "kod_name_copyright"             => "Mango Wolke • OnlineLibrary",
    "kod_meta_name"                  => "KodExplorer",
    "kod_meta_keywords"              => "KodExplorer, kod, kodCloud, webos, webIDE, php filemanage, filemanage, Dao Wolke, Wolke Mango, Dokumenten-Management-Systeme, Enterprise-Cloud-Disk, OnlineLibrary ,, Online-Dokumentation, Online-Büro, Online-Office, Online-CAD-Vorschau, die Online-Bearbeitung Der Online-Editor",
    ...
    "OnlineLibrary.UI.openWith"           => "wählen Sie Öffnen",
    "OnlineLibrary.UI.openWithText"       => "Notepad zu öffnen",
    "OnlineLibrary.UI.appSetDefault"      => "Legen Sie den Standard geöffnet",
    "OnlineLibrary.UI.appAwaysOpen"       => "Verwenden Sie immer das ausgewählte Programm diese Datei zu öffnen",
    "OnlineLibrary.UI.selectAppDesc"      => "Wählen Sie das gewünschte Programm diese Datei öffnen",
    "OnlineLibrary.UI.selectAppWarning"   => "Bitte wählen Sie die Anwendung!",
    "OnlineLibrary.UI.appTypeSupport"     => "Unterstützt",
    "OnlineLibrary.UI.appTypeAll"         => "Alle Anwendungen",
