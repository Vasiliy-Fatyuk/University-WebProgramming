...
return array(
    ...
    "OnlineLibrary.UI.openWith"           => "seleccione Abrir",
    "OnlineLibrary.UI.openWithText"       => "Bloc de notas para abrir",
    "OnlineLibrary.UI.appSetDefault"      => "Establecer la abierta por defecto",
    "OnlineLibrary.UI.appAwaysOpen"       => "Utilizar siempre el programa seleccionado para abrir este archivo",
    "OnlineLibrary.UI.selectAppDesc"      => "Seleccione el programa que desea abrir este archivo",
    "OnlineLibrary.UI.selectAppWarning"   => "Por favor seleccione la aplicación!",
    "OnlineLibrary.UI.appTypeSupport"     => "Soportado",
    "OnlineLibrary.UI.appTypeAll"         => "Todas las aplicaciones",
