...
return array(
    ...
    "OnlineLibrary.UI.openWith"           => "選擇打開方式",
    "OnlineLibrary.UI.openWithText"       => "記事本打開",
    "OnlineLibrary.UI.appSetDefault"      => "設定預設打開",
    "OnlineLibrary.UI.appAwaysOpen"       => "始終使用選擇的程式打開這種檔案",
    "OnlineLibrary.UI.selectAppDesc"      => "選擇您想用來打開此檔案的程式",
    "OnlineLibrary.UI.selectAppWarning"   => "請選擇應用!",
    "OnlineLibrary.UI.appTypeSupport"     => "支援應用",
    "OnlineLibrary.UI.appTypeAll"         => "所有應用",
