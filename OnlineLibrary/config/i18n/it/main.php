...
return array(
    ...
    "kod_name_desc"                  => "Mango nuvola • OnlineLibrary",
    "kod_power_by"                   => " - Powered by KodExplorer",
    "kod_name_copyright"             => "Mango nuvola • OnlineLibrary",
    ...
    "OnlineLibrary.UI.openWith"           => "selezionare Apri",
    "OnlineLibrary.UI.openWithText"       => "Blocco note per aprire",
    "OnlineLibrary.UI.appSetDefault"      => "Impostare l'apertura predefinito",
    "OnlineLibrary.UI.appAwaysOpen"       => "Usa sempre il programma selezionato per aprire questo file",
    "OnlineLibrary.UI.selectAppDesc"      => "Selezionare il programma che si desidera aprire questo file",
    "OnlineLibrary.UI.selectAppWarning"   => "Si prega di selezionare l'applicazione!",
    "OnlineLibrary.UI.appTypeSupport"     => "supportato",
    "OnlineLibrary.UI.appTypeAll"         => "Tutte le applicazioni",
