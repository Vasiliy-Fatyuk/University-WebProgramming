...
return array(
    ...
    "OnlineLibrary.UI.openWith"           => "selecione Abrir",
    "OnlineLibrary.UI.openWithText"       => "Bloco de notas para abrir",
    "OnlineLibrary.UI.appSetDefault"      => "Definir o padrão aberto",
    "OnlineLibrary.UI.appAwaysOpen"       => "Sempre usar o programa selecionado para abrir este arquivo",
    "OnlineLibrary.UI.selectAppDesc"      => "Selecione o programa que deseja abrir este arquivo",
    "OnlineLibrary.UI.selectAppWarning"   => "Por favor, selecione o aplicativo!",
    "OnlineLibrary.UI.appTypeSupport"     => "Suportado",
    "OnlineLibrary.UI.appTypeAll"         => "Todas as aplicações",
