...
return array(
    ...
    "OnlineLibrary.UI.openWith"           => "Виберіть Open",
    "OnlineLibrary.UI.openWithText"       => "Блокнот, щоб відкрити",
    "OnlineLibrary.UI.appSetDefault"      => "Встановити відкрито за замовчуванням",
    "OnlineLibrary.UI.appAwaysOpen"       => "Завжди використовувати вибрану програму для відкриття цього файлу",
    "OnlineLibrary.UI.selectAppDesc"      => "Виберіть програму, яку ви хочете відкрити цей файл",
    "OnlineLibrary.UI.selectAppWarning"   => "Будь ласка, виберіть додаток!",
    "OnlineLibrary.UI.appTypeSupport"     => "Підтримується",
    "OnlineLibrary.UI.appTypeAll"         => "Усі програми",
