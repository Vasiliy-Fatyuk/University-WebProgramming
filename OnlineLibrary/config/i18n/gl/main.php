...
return array(
    ...
    "OnlineLibrary.UI.openWithText"       => "Bloque de notas para abrir",
    "OnlineLibrary.UI.appSetDefault"      => "Definir o estándar aberto",
    "OnlineLibrary.UI.appAwaysOpen"       => "Usar o programa seleccionado para abrir este ficheiro",
    "OnlineLibrary.UI.selectAppDesc"      => "Seleccione o programa que desexa abrir este ficheiro",
    "OnlineLibrary.UI.selectAppWarning"   => "Por favor, seleccione a aplicación!",
    "OnlineLibrary.UI.appTypeSupport"     => "Apoiado",
    "OnlineLibrary.UI.appTypeAll"         => "Todas as aplicacións",
