...
return array(
    ...
    "OnlineLibrary.UI.openWith"           => "ওপেন নির্বাচন করুন",
    "OnlineLibrary.UI.openWithText"       => "নোটপ্যাড খুলতে",
    "OnlineLibrary.UI.appSetDefault"      => "ডিফল্ট খোলা সেট",
    "OnlineLibrary.UI.appAwaysOpen"       => "সর্বদা এই ফাইল খোলার জন্য নির্বাচিত প্রোগ্রাম ব্যবহার",
    "OnlineLibrary.UI.selectAppDesc"      => "প্রোগ্রাম নির্বাচন করুন আপনি এই ফাইলটি খুলতে চান",
    "OnlineLibrary.UI.selectAppWarning"   => "দয়া করে আবেদন নির্বাচন করুন!",
    "OnlineLibrary.UI.appTypeSupport"     => "সমর্থিত",
    "OnlineLibrary.UI.appTypeAll"         => "সমস্ত অ্যাপ্লিকেশন",
