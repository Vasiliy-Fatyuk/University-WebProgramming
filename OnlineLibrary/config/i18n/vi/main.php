...
return array(
    ...
    "kod_name_desc"                  => "Mango đám mây • OnlineLibrary",
    "kod_power_by"                   => " - Powered by KodExplorer",
    "kod_name_copyright"             => "Mango đám mây • OnlineLibrary",
    ...
    "OnlineLibrary.UI.openWith"           => "chọn mở",
    "OnlineLibrary.UI.openWithText"       => "Mở Notepad",
    "OnlineLibrary.UI.appSetDefault"      => "Đặt mở mặc định",
    "OnlineLibrary.UI.appAwaysOpen"       => "Luôn luôn sử dụng chương trình được lựa chọn để mở tập tin này",
    "OnlineLibrary.UI.selectAppDesc"      => "Chọn chương trình bạn muốn mở tập tin này",
    "OnlineLibrary.UI.selectAppWarning"   => "Vui lòng chọn các ứng dụng!",
    "OnlineLibrary.UI.appTypeSupport"     => "Hỗ trợ",
    "OnlineLibrary.UI.appTypeAll"         => "Tất cả các ứng dụng",
