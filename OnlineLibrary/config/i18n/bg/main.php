...
return array(
    ...
    "kod_name_desc"                  => "Mango облак • OnlineLibrary",
    "kod_power_by"                   => " - Powered by KodExplorer",
    "kod_name_copyright"             => "Mango облак • OnlineLibrary",
    ...
    "OnlineLibrary.UI.openWith"           => "Изберете Open",
    "OnlineLibrary.UI.openWithText"       => "Notepad за да отворите",
    "OnlineLibrary.UI.appSetDefault"      => "Задайте открито по подразбиране",
    "OnlineLibrary.UI.appAwaysOpen"       => "Винаги използвайте избраната програма да отвори този файл",
    "OnlineLibrary.UI.selectAppDesc"      => "Изберете програмата, която искате да отворите този файл",
    "OnlineLibrary.UI.selectAppWarning"   => "Моля, изберете приложението!",
    "OnlineLibrary.UI.appTypeSupport"     => "Поддържани",
    "OnlineLibrary.UI.appTypeAll"         => "Всички приложения",
