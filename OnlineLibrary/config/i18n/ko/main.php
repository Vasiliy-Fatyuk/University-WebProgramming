...
return array(
    ...
    "OnlineLibrary.UI.openWith"           => "열기를 선택",
    "OnlineLibrary.UI.openWithText"       => "메모장을 엽니 다",
    "OnlineLibrary.UI.appSetDefault"      => "기본 공개 설정",
    "OnlineLibrary.UI.appAwaysOpen"       => "항상이 파일을 열 수 선택한 프로그램 사용",
    "OnlineLibrary.UI.selectAppDesc"      => "이 파일을 열려는 프로그램을 선택",
    "OnlineLibrary.UI.selectAppWarning"   => "응용 프로그램을 선택하세요!",
    "OnlineLibrary.UI.appTypeSupport"     => "지원됨",
    "OnlineLibrary.UI.appTypeAll"         => "모든 애플리케이션",
