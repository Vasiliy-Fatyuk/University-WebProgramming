...
return array(
    ...
    "OnlineLibrary.UI.openWith"           => "seleccioneu Obre",
    "OnlineLibrary.UI.openWithText"       => "Bloc de notes per obrir",
    "OnlineLibrary.UI.appSetDefault"      => "Establir l'oberta per defecte",
    "OnlineLibrary.UI.appAwaysOpen"       => "Utilitzar sempre el programa seleccionat per obrir aquest arxiu",
    "OnlineLibrary.UI.selectAppDesc"      => "Seleccioneu el programa que voleu obrir aquest fitxer",
    "OnlineLibrary.UI.selectAppWarning"   => "Si us plau seleccioni l'aplicació!",
    "OnlineLibrary.UI.appTypeSupport"     => "Compatible",
    "OnlineLibrary.UI.appTypeAll"         => "Totes les aplicacions",
