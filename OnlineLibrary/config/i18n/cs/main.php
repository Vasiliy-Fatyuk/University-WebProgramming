...
return array(
    ...
    "OnlineLibrary.UI.openWith"           => "zvolte Otevřít",
    "OnlineLibrary.UI.openWithText"       => "Poznámkový blok k otevření",
    "OnlineLibrary.UI.appSetDefault"      => "Nastavit výchozí otevřený",
    "OnlineLibrary.UI.appAwaysOpen"       => "Vždy použít vybraný program k otevření tohoto souboru",
    "OnlineLibrary.UI.selectAppDesc"      => "Vyberte program, který chcete otevřít tento soubor",
    "OnlineLibrary.UI.selectAppWarning"   => "Prosím, vyberte aplikaci!",
    "OnlineLibrary.UI.appTypeSupport"     => "Podporováno",
    "OnlineLibrary.UI.appTypeAll"         => "Všechny aplikace",
