...
return array(
    ...
    "OnlineLibrary.UI.openWith"           => "Choose the way to open",
    "OnlineLibrary.UI.openWithText"       => "Notepad open",
    "OnlineLibrary.UI.appSetDefault"      => "Set the default to open",
    "OnlineLibrary.UI.appAwaysOpen"       => "Always use the selected program to open this file",
    "OnlineLibrary.UI.selectAppDesc"      => "Select the program you want to use to open this file",
    "OnlineLibrary.UI.selectAppWarning"   => "Please choose to apply!",
    "OnlineLibrary.UI.appTypeSupport"     => "Supported",
    "OnlineLibrary.UI.appTypeAll"         => "All applications",
