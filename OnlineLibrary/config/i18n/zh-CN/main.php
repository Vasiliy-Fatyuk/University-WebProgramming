...
return array(
    ...
    "OnlineLibrary.UI.openWith"           => "选择打开方式",
    "OnlineLibrary.UI.openWithText"       => "记事本打开",
    "OnlineLibrary.UI.appSetDefault"      => "设置默认打开",
    "OnlineLibrary.UI.appAwaysOpen"       => "始终使用选择的程序打开这种文件",
    "OnlineLibrary.UI.selectAppDesc"      => "选择您想用来打开此文件的程序",
    "OnlineLibrary.UI.selectAppWarning"   => "请选择应用!",
    "OnlineLibrary.UI.appTypeSupport"     => "支持应用",
    "OnlineLibrary.UI.appTypeAll"         => "所有应用",
