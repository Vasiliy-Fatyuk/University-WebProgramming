...
return array(
    ...
    "OnlineLibrary.UI.openWith"           => "حدد فتح",
    "OnlineLibrary.UI.openWithText"       => "المفكرة لفتح",
    "OnlineLibrary.UI.appSetDefault"      => "تعيين مفتوحة الافتراضي",
    "OnlineLibrary.UI.appAwaysOpen"       => "دائما استخدام البرنامج المحدد لفتح هذا الملف",
    "OnlineLibrary.UI.selectAppDesc"      => "حدد البرنامج الذي تريد فتح هذا الملف",
    "OnlineLibrary.UI.selectAppWarning"   => "يرجى اختيار التطبيق!",
    "OnlineLibrary.UI.appTypeSupport"     => "أيد",
    "OnlineLibrary.UI.appTypeAll"         => "جميع التطبيقات",
