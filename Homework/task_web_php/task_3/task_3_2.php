...
<h3>
    <div class="result">
        ...
        for ($i=0; $i < count($object_array); $i++) {
            echo "<div>Країна:</div>"; echo "<div>"; echo $object_array[$i]->name; echo "</div>";
            echo "Населення: "; echo "<div>"; echo $object_array[$i]->populations; echo "</div>";
            echo "<div>Столиця:</div>"; echo "<div>"; echo $object_array[$i]->capital; echo "</div>";
            echo "<br> </br>";
            echo "<div> </div>";
        }
        ?>
	...
	<div class="container bloc-lg">
		<div class="row">
			<div class="col-sm-12">
				...
				<p class=" text-left">
                    Створіть клас країни в якому будуть поля: назва країни, населення і назва столиці (англійські назви придумайте самостійно).<br>
                    Створіть масив об'єктів, виведіть кожний з них у таблицю в три рядки по дві комірки в кожному.<br>
	...
	<div class="container bloc-lg">
		<div class="row">
			<div class="col-sm-12">
				...
				<p class=" text-left">
                    &nbsp;&lt;?php<br><br>class Country {<br><br> public $name;<br> public $populations;<br> public $capital;<br> function __construct($name, $populations, $capital) {<br> $this -&gt; name = $name;<br> $this -&gt; populations = $populations;<br> $this -&gt; capital = $capital;<br> }<br><br>}<br>?&gt;<br><br>&lt;?php<br><br>$array_with_country = ['Україна', 'Німечина', 'Іспанія', 'Росія', 'США'];<br>$array_with_population = [47000000, 24000000, 11000000, 98000000, 9000000];<br>$array_with_capital = ['Київ', 'Берлін', 'Мадрид', 'Москва', 'Вашингтон'];<br><br>$object_array = array();<br>for ($i=0; $i &lt; count($array_with_country); $i++) {<br> array_push($object_array, new Country($array_with_country[$i], $array_with_population[$i], $array_with_capital[$i]));<br>}<br><br>?&gt;<br><br>&lt;div class="result"&gt;<br> &lt;?php<br> for ($i=0; $i &lt; count($object_array); $i++) {<br> echo "&lt;div&gt;Країна:&lt;/div&gt;"; echo "&lt;div&gt;"; echo $object_array[$i]-&gt;name; echo "&lt;/div&gt;";<br> echo "Населення: "; echo "&lt;div&gt;"; echo $object_array[$i]-&gt;populations; echo "&lt;/div&gt;";<br> echo "&lt;div&gt;Столиця:&lt;/div&gt;"; echo "&lt;div&gt;"; echo $object_array[$i]-&gt;capital; echo "&lt;/div&gt;";<br> echo "&lt;br&gt; &lt;/br&gt;";<br> echo "&lt;div&gt; &lt;/div&gt;";<br> }<br> ?&gt;<br> &lt;/div&gt;<br>
                </p>
			</div>
		</div>
	</div>
