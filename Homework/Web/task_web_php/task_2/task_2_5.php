            ...
            <div class="container bloc-lg">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p class=" text-left">
                            Створити скрипт підрахунку кількості загрузок певного файлу і заборонити завантаження файлу
                            після 10 таких завантажень<br>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="container bloc-lg">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p class=" text-left">
                            &lt;?php<br>session_start();<br>if (!isset($_SESSION['file_name_array']))
                            $_SESSION['file_name_array'] = json_encode(['test']);<br>function getFileNameArray() {<br>
                            return json_decode($_SESSION['file_name_array']);<br>}<br>function
                            setValueInFileNameArray($value) {<br> $arr = getFileNameArray();<br> array_push($arr,
                            $value);<br> $_SESSION['file_name_array'] = json_encode($arr);<br>}<br>function
                            checkUploadCount($value) {<br> $arr = getFileNameArray();<br> $arr =
                            array_count_values($arr);<br> if (isset($arr[$value]) &amp;&amp; $arr[$value] &gt; 9) return
                            false;<br> return true;<br>}<br>?&gt;<br>&lt;form enctype="multipart/form-data" action="#"
                            method="post"&gt;<br> &lt;input type="hidden" name="MAX_FILE_SIZE" value="30000" /&gt;<br>
                            &lt;input name="file" type="file" /&gt;<br> &lt;input type="submit" value="Відправити файл"
                            /&gt;<br><br><br> &lt;?php<br> if($_SERVER['REQUEST_METHOD'] == "POST") {<br> $file =
                            $_FILES['file']['name'];<br> if (checkUploadCount($file)) {<br>
                            setValueInFileNameArray($file);<br> echo "&lt;div class='success'&gt;Файл додано&lt;/div&gt;";<br>
                            } else {<br> echo "&lt;div class='error'&gt;Файл не додано&lt;/div&gt;";<br> }<br> }<br> ?&gt;<br><br>&lt;/form&gt;<br>
                        </p>
                    </div>
                </div>
            </div>
