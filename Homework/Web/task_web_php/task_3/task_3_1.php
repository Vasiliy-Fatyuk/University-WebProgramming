            ...
            <div class="container bloc-lg">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p class=" text-left">
                            Створіть клас для виведення таблиці множення для вказаного числа (передавати в
                            конструкторі).<br>
                            Створити окремий метод для обчислення. Далі створити кілька об'єктів даного класу для
                            демонстрації працездатності класу.<br>
            ...
            <div class="container bloc-lg">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p class=" text-left">
                            &lt;?php<br>class MultiplicationTable {<br><br> public $value;<br> function
                            __construct($value) {<br> $this-&gt;value = $value;<br> }<br><br> public function
                            getMultiplicationTable() {<br> $result_array = array();<br> for ($i=0; $i &lt;= 9; $i++)
                            array_push($result_array, $i * $this-&gt;value);<br> return $result_array;<br> }<br><br>
                            public function renderResultTable() {<br> for ($i=1; $i &lt; count($this-&gt;getMultiplicationTable());
                            $i++) {<br> echo $i;<br> echo " * ";<br> echo $this-&gt;value;<br> echo " = ";<br> echo
                            $this-&gt;getMultiplicationTable()[$i];<br> echo "&lt;br&gt;";<br> }<br> }<br><br>}<br>?&gt;
                            <br> <br> <br>&lt;div class="content"&gt;<br> &lt;div&gt;<br> &lt;?php<br> $table1 = new
                            MultiplicationTable("4");<br> $table1 -&gt; renderResultTable();<br> ?&gt;<br>
                            &lt;/div&gt;<br> &lt;div&gt;<br> &lt;?php<br> $table1 = new MultiplicationTable("6");<br>
                            $table1 -&gt; renderResultTable();<br> ?&gt;<br> &lt;/div&gt;<br> &lt;div&gt;<br>
                            &lt;?php<br> $table1 = new MultiplicationTable("8");<br> $table1 -&gt;
                            renderResultTable();<br> ?&gt;<br> &lt;/div&gt;<br> &lt;/div&gt;<br>
                        </p>
                    </div>
                </div>
            </div>
