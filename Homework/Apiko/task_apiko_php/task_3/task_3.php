    ...
    <div class
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <script src="../../task_apiko_js/task_3/bundle.js"></script>
                        ...
                        <div class="container bloc-lg">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <p class=" text-left">
                                        Ознайомитися із вступною документацією React https://reactjs.org/docs/мhello-world.html.
                                        <br>

                                        <br><br><br>
                                        Реалізувати завдання із попередньої лекції за допомогою React.
                        ...
                        <div class="container bloc-lg">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <p class=" text-left">
                                        https://github.com/Vasiliy-Fatyuk/University-WebProgramming<br>
                                        <br><br>
                                    </p>
                                </div>
                            </div>
